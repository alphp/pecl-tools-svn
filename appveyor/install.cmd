...
setlocal enableextensions enabledelayedexpansion
	...
	wget -N --progress=bar:force:noscroll https://sourceforge.net/projects/win32svn/files/1.8.17/apache24/svn-win32-1.8.17-ap24_dev.zip/download -P %CACHE_ROOT%
	7z x -y %CACHE_ROOT%\svn-win32-1.8.17-ap24_dev.zip -oC:\projects\svn-1.8.17
